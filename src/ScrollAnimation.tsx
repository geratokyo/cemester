/**
 * This class is created by dbramwell, and moved to the project for easier integration with typescript. 
 * The project repository can be found in this link 
 * 
