...
class App extends React.Component<any, any>{
    ...
    componentDidMount(){
        window.addEventListener("scroll", this.setScrollPercent)
    }

    componentWillUnmount(){
        window.removeEventListener("scroll", this.setScrollPercent); 
    }

    setScrollPercent = ()=>{
        let progress = this.getScrollPercent(); 
        this.setState({
            progress
        })
    }
        ...
        return (
            ...
            >
                <div className="App_progress">
                    <progress className="progress-bar" value={this.state.progress * 100} max={100}></progress>
                </div>
                <Cemester
                    content={CONTENT}
                    customComponents={(e) => {
