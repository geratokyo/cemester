...
class App extends React.Component<any, any>{
    ...
    componentWillUnmount() {
        window.removeEventListener("scroll", this.shouldNavBeFixed);
    }


    // Consider adding a throttle to this function so it is not being called multiple times
    shouldNavBeFixed = () => {
        ...
        let offset = h[st] || b[st]
        this.setState({
            isNavFixed: offset > WH
        })
    }
    ...
    render() {
        return (
            ...
            >
                <header className={this.state.isNavFixed ?"navbar-fixed":""}>
                    <nav>
                        <ul>
                            <li>
